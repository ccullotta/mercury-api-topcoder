...
namespace topcoderattempt1.Migrations.Mercury
{
    ...
    [Migration("20200617232718_add Status location relationship2")]
    partial class addStatuslocationrelationship2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("topcoderattempt1.Models.Keyholder", b =>
                {
                    ...
                    b.HasIndex("KeySerialNumber")
                        .IsUnique()
                        .HasFilter("[KeySerialNumber] IS NOT NULL");
            ...
            modelBuilder.Entity("topcoderattempt1.Models.Location", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("topcoderattempt1.Models.ChangeEmailRequest", b =>
                {
                    b.HasOne("topcoderattempt1.Models.UserModel", "User")
                        .WithMany("ChangeEmailRequests")
            ...
            modelBuilder.Entity("topcoderattempt1.Models.Keyholder", b =>
                {
                    b.HasOne("topcoderattempt1.Models.UserKeyMapping", "UserKeyMapping")
                        .WithOne("Keyholder")
                        .HasForeignKey("topcoderattempt1.Models.Keyholder", "KeySerialNumber")
                        .HasPrincipalKey("topcoderattempt1.Models.UserKeyMapping", "KeySerialNumber");
                });

            modelBuilder.Entity("topcoderattempt1.Models.UserKeyMapping", b =>
                {
                    b.HasOne("topcoderattempt1.Models.Location", "Location")
                        .WithMany("UserKeyMappings")
            ...
            modelBuilder.Entity("topcoderattempt1.Models.UserStatus", b =>
                {
                    b.HasOne("topcoderattempt1.Models.UserLocation", "UserLocation")
                        .WithOne("Status")
                        .HasForeignKey("topcoderattempt1.Models.UserStatus", "ID")
                        .HasPrincipalKey("topcoderattempt1.Models.UserLocation", "StatusId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("topcoderattempt1.Models.Location", null)
